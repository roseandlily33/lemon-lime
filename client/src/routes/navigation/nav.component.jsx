        ...
        <Navbar>
            ...
            <RightNav>
              ...
              {isOpen ? 
               ...
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="30" width="30" class="icon-thumbs-up">
               ...
               <rect width="4" height="11" x="18" y="11" class="secondary" rx="1"/></svg>
               </NavLink>
               <NavLink to='user/home'>
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="30" width="30"  class="icon-user">
                 <path class="primary" d="M12 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10z"/>
               <path class="secondary" d="M21 20v-1a5 5 0 0 0-5-5H8a5 5 0 0 0-5 5v1c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2z"/></svg>
               </NavLink>
              ...
              <>
              <NavLink to='search'>
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="30" width="30" class="icon-search">
                <circle cx="10" cy="10" r="7" class="primary"/><path class="secondary" d="M16.32 14.9l1.1 1.1c.4-.02.83.13 1.14.44l3 3a1.5 1.5 0 0 1-2.12 2.12l-3-3a1.5 1.5 0 0 1-.44-1.14l-1.1-1.1a8 8 0 1 1 1.41-1.41zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"/></svg>
               </NavLink>

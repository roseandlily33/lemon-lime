        ...
        <Navbar className='boxShadow'>
            ...
            <RightNav>
             ...
             {isMobile ?
               ...
               <svg onClick={() => setOpen(false)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="30" width="30"  class="icon-user">
               ...
               <button onClick={() =>logout()}>Logout</button>
                  ...
                  : 
                  <>
                  <h2 >Mobile, not open and not authenticated</h2>
